const Hero = () => {
  return (
    <section className="relative after:bg-[url('/images/hero/bg-grid.png')] after:bg-accent after:filter after:opacity-25 after:bg-[length:100px_100px] after:absolute after:inset-0 after:bg-top after:z-[-1]">
